...
export const adminCopy = {
  ...
  klendPageDescription:
    "Deploy idle collateral to Kamino, recall it for redemptions, then harvest or sweep surplus into the treasury.",
  klendHarvestSweepBlurb: [
    ...
    "Recall brings principal and yield home together, so both buttons exist. Harvest is optional if you want the yield without recalling. Neither touches user principal. Paying the operator out of the treasury is on the Treasury page.",
  ],
  treasuryVaultNav: "Treasury",
  treasuryVaultSubtitle: "Treasury",
  treasuryVaultPageTitle: "Treasury",
  treasuryVaultPageDescription:
    "Withdraw protocol yield from the treasury vault to an operator wallet. Harvest and sweep on Yield fill this vault.",
  klendTreasuryBlurb: [
    "Withdraw treasury pays the operator: move tokens already sitting in the treasury vault out of the protocol. Harvest and sweep on Yield fill the treasury; this page empties it.",
  ],
  klendNoAssets: "No registered collateral assets.",
  klendNotEnabled: "Kamino is not enabled for this asset. Vault-only ops (sweep) still apply.",
  klendDeploy: "Deploy",
  klendRecall: "Recall",
  klendHarvest: "Harvest",
  klendHarvestHint: "Capped by live Kamino surplus and reserve free liquidity. On-chain harvest_yield enforces the same cap.",
  klendHarvestable: "Harvestable",
  klendSweep: "Sweep surplus",
  klendWithdrawTreasury: "Withdraw treasury",
  klendReviewWithdrawal: "Review withdrawal",
  klendConfirmWithdrawal: "Confirm withdrawal",
  klendDeployAmount: "Deploy amount",
  klendRecallAmount: "Recall amount",
  klendHarvestAmount: "Harvest amount",
  klendSweepAmount: "Sweep amount",
  klendTreasuryAmount: "Amount to withdraw",
  ...
  klendAvailableTreasury: "Available to withdraw",
  klendTreasuryMaxRentCaption:
    "Token Max does not reserve rent — ATA rent and the ~0.00001 SOL fee are paid from the admin SOL wallet, not deducted from the treasury token.",
  klendYouWillReceive: "You will receive",
  klendRemainingTreasury: "Remaining treasury balance",
  klendNetworkFee: "Network fee: ~0.00001 SOL (admin SOL)",
  klendIrreversible: "This action cannot be reversed.",
  klendUnfamiliarConfirm: "I confirm this destination is correct.",
  klendHistoryEmpty: "No withdrawals indexed yet.",
  klendHistoryTitle: "Withdrawal history",
  klendSubmitting: "Submitting…",
  klendConfirmed: "Confirmed",
...
export const metricHints = {
  ...
  kaminoSurplus: {
    ...
    hint: "Live unharvested Kamino yield above deployed principal (reserve mark after a simulated refresh). Harvest moves it to the treasury.",
  },
  liabilityUnderlying: {
